<html>
    <table class="tftable" style="font-size: 12px; color: #333333; width: 60%; border-width: 1px; border: 1px solid #000; border-collapse: collapse; font-family: arial, sans-serif;">
        <tr style="background-color: #ffffff;" bgcolor="#ffffff">
          <th style="font-size: 14px; text-align: center;" align="center" colspan="4"><b>DATA UKURAN SERAGAM CALON SISWA/SISWI</b></th>
        </tr>
        <tr style="background-color: #ffffff;" bgcolor="#ffffff">
        ...
        <tr style="background-color: #ffffff;" bgcolor="#ffffff">
          ...
          <td style="font-size: 12px; border-width: 1px; padding: 7px 5px; border-style: solid; border: 1px solid #000; text-align: center;"><b>UKURAN</b></td>
        </tr>
        @foreach ($data as $key => $item)
            <tr style="background-color: #ffffff;" bgcolor="#ffffff">
                ...
                <td style="font-size: 12px; padding: 7px 5px; border-style: solid; border: 1px solid #000;">{{ $item['ukuran_seragam'] ?? '' }}</td>
            </tr>
        @endforeach
      </table>
</html>