                ...
                <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="#" class="ml-1 text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">FAQ</a>
                        </div>
                    </li>
                </ol>
            </nav>
            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">FAQ</h1>
        </div>
        <div class="sm:flex">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <td class="p-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900 dark:text-white">{{ $data->pertanyaan }}</div>
                            </td>
                            <td class="p-4 whitespace-wrap">
                                <div class="text-sm text-gray-900 dark:text-white">{{ $data->jawaban }}</div>
                            </td>
            ...
            <div class="modal-body">
                <form id="formAdd">
                    <div class="">
                        {{ csrf_field() }}
                        <div class="mb-4">
                            <label for="pertanyaanAdd" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pertanyaan <span class="text-red-500">*</span></label>
                            <input type="text" name="pertanyaan" id="pertanyaanAdd" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Pertanyaan" required>
                        </div>
                        <div class="mb-4">
                            <label for="jawabanAdd" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jawaban <span class="text-red-500">*</span></label>
                            <textarea type="text" name="jawaban" id="jawabanAdd" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="jawaban" required></textarea>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="modal-body">
                <form id="formEdit">
                    <div class="">
                        ...
                        <div class="mb-4">
                            <label for="pertanyaanEdit" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pertanyaan <span class="text-red-500">*</span></label>
                            <input type="text" name="pertanyaan" id="editpertanyaan" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Tahap" required>
                        </div>
                        <div class="mb-4">
                            <label for="jawabanEdit" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jawaban <span class="text-red-500">*</span></label>
                            <textarea type="text" name="jawaban" id="editjawaban" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="jawaban" required></textarea>
                        </div>
                    </div>
                </form>
            </div>
        ...
        axios({
            ...
            .then(function(response) {
                if (response.data.status == "OK") {
                    ...
                    document.getElementById("editpertanyaan").value = response.data.results.pertanyaan;
                    document.getElementById("editjawaban").value = response.data.results.jawaban;
